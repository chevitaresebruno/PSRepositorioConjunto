Feature: Gerenciar Tarefa

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Tarefa
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Tarefa
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Tarefa
